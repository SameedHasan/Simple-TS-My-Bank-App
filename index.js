...
async function promptForAmount(str) {
...
async function main() {
    ...
    const customer = new Customer("Sameed", "Hasan", "Male", 24, "03355520338", myAccount);
    //   co
    while (true) {
        ...
        if (answer.action === "Debit") {
            ...
            //   customer.bankAccount.checkBalance();
        }
            ...
            console.log(`Your current account balance: `, customer.getCustomerInfo().accountBalance);
        }
